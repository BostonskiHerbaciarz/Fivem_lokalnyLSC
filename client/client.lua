...
RegisterNetEvent('boston_repairLSC:success')
AddEventHandler('boston_repairLSC:success', function(price)
...
RegisterNetEvent('boston_repairLSC:successpremium')
AddEventHandler('boston_repairLSC:successpremium', function(price)
local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:notenoughmoney')
AddEventHandler('boston_repairLSC:notenoughmoney', function(moneyleft)
...
RegisterNetEvent('boston_repairLSC:notenoughmoneypremium')
AddEventHandler('boston_repairLSC:notenoughmoneypremium', function(moneyleft)
...
function AutoRepair()
    ...
    function(data, menu)
        ...
        if action == "repair_fast" then
             TriggerServerEvent('boston_repairLSC:checkmoneypremium')
        elseif action == "repair_slow" then
            TriggerServerEvent('boston_repairLSC:checkmoney')
        end
        menu.close()
...
RegisterNetEvent('boston_repairLSC:successSS')
AddEventHandler('boston_repairLSC:successSS', function(price)
	local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:successpremiumSS')
AddEventHandler('boston_repairLSC:successpremiumSS', function(price)
local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:notenoughmoneySS')
AddEventHandler('boston_repairLSC:notenoughmoneySS', function(moneyleft)
	exports['mythic_notify']:DoCustomHudText('error', 'Nie masz wystarczająco dużo pieniędzy w banku aby zakupić Pakiet Mini!', 3500)
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)

RegisterNetEvent('boston_repairLSC:notenoughmoneypremiumSS')
AddEventHandler('boston_repairLSC:notenoughmoneypremiumSS', function(moneyleft)
	exports['mythic_notify']:DoCustomHudText('error', 'Nie masz wystarczająco dużo pieniędzy w banku aby kupić Pakiet Premium!', 3500)
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
...
function AutoRepairSS()
    ...
    function(data, menu)
        ...
        if action == "repair_fastSS" then
             TriggerServerEvent('boston_repairLSC:checkmoneypremiumSS')
        elseif action == "repair_slowSS" then
            TriggerServerEvent('boston_repairLSC:checkmoneySS')
        end
        menu.close()
    end, function(data, menu)
        menu.close()
...
RegisterNetEvent('boston_repairLSC:successPB')
AddEventHandler('boston_repairLSC:successPB', function(price)
	local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:successpremiumPB')
AddEventHandler('boston_repairLSC:successpremiumPB', function(price)
local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:notenoughmoneyPB')
AddEventHandler('boston_repairLSC:notenoughmoneyPB', function(moneyleft)
	exports['mythic_notify']:DoCustomHudText('error', 'Nie masz wystarczająco dużo pieniędzy w banku aby zakupić Pakiet Mini!', 3500)
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)

RegisterNetEvent('boston_repairLSC:notenoughmoneypremiumPB')
AddEventHandler('boston_repairLSC:notenoughmoneypremiumPB', function(moneyleft)
	exports['mythic_notify']:DoCustomHudText('error', 'Nie masz wystarczająco dużo pieniędzy w banku aby kupić Pakiet Premium!', 3500)
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
...
function AutoRepairPB()
    ...
    function(data, menu)
        ...
        if action == "repair_fastPB" then
             TriggerServerEvent('boston_repairLSC:checkmoneypremiumPB')
        elseif action == "repair_slowPB" then
            TriggerServerEvent('boston_repairLSC:checkmoneyPB')
        end
        menu.close()
    end, function(data, menu)
        menu.close()
...
RegisterNetEvent('boston_repairLSC:successAirPort')
AddEventHandler('boston_repairLSC:successAirPort', function(price)
	local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:successpremiumAirPort')
AddEventHandler('boston_repairLSC:successpremiumAirPort', function(price)
local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(GetPlayerPed(-1)))
	local veh = GetClosestVehicle(x, y, z, 4.001, 0, 70)
	local veh2 = GetVehiclePedIsIn (GetPlayerPed (-1), true)
...
RegisterNetEvent('boston_repairLSC:notenoughmoneyAirPort')
AddEventHandler('boston_repairLSC:notenoughmoneyAirPort', function(moneyleft)
	exports['mythic_notify']:DoCustomHudText('error', 'Nie masz wystarczająco dużo pieniędzy w banku aby zakupić Pakiet Mini!', 3500)
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)

RegisterNetEvent('boston_repairLSC:notenoughmoneypremiumAirPort')
AddEventHandler('boston_repairLSC:notenoughmoneypremiumAirPort', function(moneyleft)
	exports['mythic_notify']:DoCustomHudText('error', 'Nie masz wystarczająco dużo pieniędzy w banku aby kupić Pakiet Premium!', 3500)
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
...
function AutoRepairAirPort()
    ...
    function(data, menu)
        ...
        if action == "repair_fastAirPort" then
             TriggerServerEvent('boston_repairLSC:checkmoneypremiumAirPort')
        elseif action == "repair_slowAirPort" then
            TriggerServerEvent('boston_repairLSC:checkmoneyAirPort')
        end
        menu.close()
    end, function(data, menu)
        menu.close()
